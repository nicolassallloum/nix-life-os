...
const routes = [
  ...
  },
  {
    ...
    meta: { requiresAuth: true, requiresRole: 'admin', permissions: ['security.view'], title: 'Security' },
  },
  {
    path: '/security/audit-logs',
    name: 'SecurityAuditLogs',
    component: SecurityAuditLogsView,
    meta: { requiresAuth: true, requiresRole: 'admin', permissions: ['security.view'], title: 'Audit Logs' },
  },
...
router.beforeEach((to, _from, next) => {
  ...
  if (to.meta?.requiresAuth && isAuthenticated && !canAccessRoute(to, user)) {
