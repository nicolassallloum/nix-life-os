        ...
        <form class="mt-5 space-y-4" @submit.prevent="saveFood">
          <div>
            ...
            <input
              ...
              required
              type="text"
              class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600/20"
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select
                v-model="form.unit"
                required
                class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600/20"
              >
        ...
        <div class="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div class="flex gap-2">
            <input
              v-model="search"
              type="text"
              class="rounded-xl border border-slate-300 px-4 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600/20"
...
function editFood(food) {
  ...
  form.value = {
    ...
    unit: food.serving_unit || food.unit || "g",
      ...
      h("div", {}, [
        ...
        h("div", { class: "relative" }, [
          h("input", {
            ...
            step: "0.01",
            class:
              "w-full rounded-xl border border-slate-300 px-4 py-3 pr-12 text-sm text-slate-900 placeholder:text-slate-400 focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600/20",
