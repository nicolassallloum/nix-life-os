...
Frontend:http://127.0.0.1Laravel Backend Direct:http://127.0.0.1:8000Laravel API Through Main Nginx:http://127.0.0.1/apiPython AI Engine Direct:http://127.0.0.1:5000Python AI Engine Through Main Nginx:http://127.0.0.1/aiPostgreSQL:Host: 127.0.0.1Port: 5445Database: nixlifeos_dbUser: nixlifeos_user
