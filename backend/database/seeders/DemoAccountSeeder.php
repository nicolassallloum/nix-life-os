    ...
    private function seedMedications(string $userId, Carbon $now): void
    {
        DB::table('health_medications')->insert([
            [
                'id' => (string) Str::uuid(),
                'user_id' => $userId,
                'medication_name' => 'Iron Supplement Demo',
                'dosage' => '1 tablet',
                'daily_dose' => '1 tablet daily',
                'dose_times' => json_encode(['09:00']),
                'frequency' => 'Daily',
                'start_date' => $now->copy()->subDays(20)->toDateString(),
                'end_date' => null,
                'status' => 'active',
                'prescribed_by' => 'Demo Doctor',
                'doctor_name' => 'Demo Doctor',
                'daily_times' => 1,
                'notes' => 'Demo medication for testing medication dashboard.',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'id' => (string) Str::uuid(),
                'user_id' => $userId,
                'medication_name' => 'Vitamin D Demo',
                'dosage' => '1000 IU',
                'daily_dose' => '1000 IU daily',
                'dose_times' => json_encode(['13:00']),
                'frequency' => 'Daily',
                ...
                'doctor_name' => 'Demo Doctor',
                'daily_times' => 1,
                'notes' => 'Demo medication for testing active medication list.',
                'created_at' => $now,
                'updated_at' => $now,
            ],
        ]);
